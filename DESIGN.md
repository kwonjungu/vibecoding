...
| 블록 | 상한 | 기준 |
|---|---|---|
| `why` | 450자 | 왜 필요한지만. 개념 재설명과 앞 칸 요약을 넣지 않는다 |
| `how` | 1,800자 | 단계 문장은 남기고 그 사이 설명을 뺀다 |
| `check` | 220자 | 관찰 가능한 항목 세 줄이면 충분하다 |
| `trouble` | 900자 (항목당 160자) | 증상·원인·해결 각 한 문장 |
| `cards` | 1,100자 | 카드마다 두세 문장 |
| `checklist` | 400자 | |
| 꼬리 섹션 | 700자 | 표는 제외이므로 설명만 |
