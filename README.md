...
코딩을 몰라도 앱을 만들 수 있을까요. **브라우저만으로, 무료로, 쉬운 것부터 어려운 것까지** 아홉 칸을 차례로 오르는 초등 교사용 실습 페이지입니다.
...
| 5 | 결과 모으기 | 구글 시트 · Apps Script | 시트에 쌓이는 학생 결과 |
| 6 | 서버 체험 — 게임과 기록표 | AI Studio Build · Firebase | 링크만 공유하면 동시 접속 |
| 7 | 서버 활용 — 날짜별 사진 캘린더 | Firestore | 하루 한 장, 규격 고정 |
| 8 | 앱이 AI를 부르게 | Gemini API 키 | 힌트 버튼 |
